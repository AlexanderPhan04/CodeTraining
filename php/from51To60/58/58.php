...
<?php
    ...
    */
    ...
    $cookieValue = "Alex"; // giá trị cookie có thể thay thê đổi được để sửa cookie

    setcookie($cookieName, $cookieValue, time()-(2592000), "/"); // thời gian hết hạn cookie là 30 ngày thay đổi dấu cộng thành dấu trừ để xóa cookie
